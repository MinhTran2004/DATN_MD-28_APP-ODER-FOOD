...
export default class Component_cart {
  static CartVertical = ({
    ...
    const acceptAction = () => {
      asyncRemoveProductFromWishlist(product);
      setDialogVisible(false);
    };

    const renderRightActions = (
      _progress: Animated.AnimatedInterpolation<string>,
        ...
        <View style={styles.container_product_vertical}>
          ...
          <View
            ...
            <View style={{width: '100%', flexDirection: 'row'}}>
              <Text style={styles.price_product_vertical}>
                ${product.price * quantity}
              </Text>

              <View style={styles.container_operation}>
                <TouchableOpacity
                  onPress={() => addProductToWishlist(product, 1)}>
