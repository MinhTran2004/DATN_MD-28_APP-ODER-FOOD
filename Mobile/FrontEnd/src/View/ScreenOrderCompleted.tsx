...
export default function ScreenOrderCompleted ({ navigation }: any) {

    const ItemOderCompleted = () => {
        return (
            <View style={styles.container}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontSize: 15, color: 'red', marginTop: 10 }}>(Hoàn Thành)</Text>
                        </View>
                        
                        <TouchableOpacity onPress={() => navigation.navigate('InForOder')} style={{ margin: 10, justifyContent: 'center', alignItems: 'center' }}>
