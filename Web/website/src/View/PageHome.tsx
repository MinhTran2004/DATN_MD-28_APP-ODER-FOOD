...
import styles from '../CSS/CSS_PageHome.module.css';
                ...
                <div className={styles.container_baner}>
                    ...
                    <div className={styles.banner2}>
                        <div className={styles.item_banner2}>
                            ...
                            <img src={require('../Image/icon_revenue.png')} alt="" className={styles.image_banner2} style={{ backgroundColor: '#4098fe' }} />
                        </div>
                        <div className={styles.item_banner2} style={{ margin: '15px 0' }}>
                            ...
                            <img src={require('../Image/icon_product.png')} alt="" className={styles.image_banner2} style={{ backgroundColor: '#2fd4b5' }} />
                        </div>
                        <div className={styles.item_banner2}>
                            <div>
                            ...
                            <img src={require('../Image/icon_user.png')} alt="" className={styles.image_banner2} style={{ backgroundColor: '#fdb54d' }} />
                        </div>
                    </div>
                </div>
